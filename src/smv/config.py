...
# LLM Tool-Call Settings
ALLOW_LLM_TOOL_CALLS: bool = True
MAX_LLM_TOOL_CALLS_PER_REQUEST: int = 6
MAX_TOOL_DIRECTORY_ENTRIES: int = 120
MAX_TOOL_FIND_RESULTS: int = 120
MAX_TOOL_FIND_DEPTH: int = 6
